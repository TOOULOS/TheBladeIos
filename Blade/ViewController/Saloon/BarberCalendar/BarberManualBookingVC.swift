...
class BarberManualBookingVC: UIViewController {
    ...
    @IBAction func onClickAddManual(_ sender: UIButton) {
        let vw = self.storyboard?.instantiateViewController(withIdentifier: "AddManualBookingVC") as! AddManualBookingVC
...
extension BarberManualBookingVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if slotArray[indexPath.row].isManual == 1 {
            startIndex = -1
            endIndex = -1
            btnBooking.setTitle(NSLocalizedString("Remove Block Off Time", comment: "Remove Block Off Time"), for: .normal)
            ...
            btnBooking.setTitle(NSLocalizedString("Block Off Time", comment: "Block Off Time"), for: .normal)
            slotCV.reloadData()
        }
    }
}

extension BarberManualBookingVC: FSCalendarDataSource, FSCalendarDelegate, FSCalendarDelegateAppearance {
